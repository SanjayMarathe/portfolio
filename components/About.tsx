export default function About() {
  return (
    <section id="about" className="py-32 px-6 lg:px-8 bg-white dark:bg-black border-t border-neutral-200 dark:border-neutral-900 transition-colors">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="md:col-span-8">
            <p className="text-black dark:text-neutral-300 text-lg leading-relaxed mb-8">
            ...
            <p className="text-neutral-800 dark:text-neutral-400 leading-relaxed mb-8">
