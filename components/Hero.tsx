...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 lg:px-8 pt-20 bg-black">
      <div className="max-w-5xl mx-auto w-full">
        <div className="space-y-8 animate-fade-in">
          <div className="space-y-6">
            ...
            <p className="text-neutral-400 text-lg sm:text-xl max-w-xl leading-relaxed animate-fade-in-up-delay-2">
