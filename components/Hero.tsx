      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="space-y-8 animate-fade-in">
          <div className="space-y-6">
            ...
            <p className="text-black dark:text-neutral-400 text-lg sm:text-xl max-w-xl leading-relaxed animate-fade-in-up-delay-2">
          ...
          <div className="flex items-center gap-6 pt-4 animate-fade-in-up-delay-3">
            <Link
              ...
              className="text-black dark:text-neutral-400 hover:text-[#7C3AED] transition-colors text-sm tracking-wide uppercase underline underline-offset-4 decoration-neutral-400 dark:decoration-neutral-700 hover:decoration-[#7C3AED]"
            >
              GitHub
            </Link>
            <Link
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 animate-fade-in-up-delay-4">
          <Link href="#about" className="text-neutral-600 dark:text-neutral-600 hover:text-[#7C3AED] transition-colors">
